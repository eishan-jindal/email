...
<table width=90%>
	...
	<td>
<?php
$res=mysql_query("select * from emsg where rid='$uid' order by sn desc");
...
echo"<table>";
echo"<tr><th>From</th><th>Subject</th><th>Message</th></tr>";
for($i=0;$i<$cnt;$i++)
{
	$a1=mysql_result($res,$i,"sid");
	$a2=mysql_result($res,$i,"sub");
	$a3=mysql_result($res,$i,"msg");
	$a4=mysql_result($res,$i,"sn");
	$a3=substr($a3,0,10);
	echo"<tr><td><b>$a1</b></td><td>$a2</td><td><a href=inbox1.php?sn=$a4>$a3</a></td></tr>";
}
echo"</table>";
